...
<head>
	...
	<title>{{ first_name }} {{ last_name }}</title>
    	...
    	<meta name="application-name" content="Eli Gladman">
...
<div class="container center-child hug-bottom hug-top">
    <div class="hero">
        <div class="container center-child hug-top">
            <span class="badge badge-blue">Currently Looking</span>
        </div>
        <p>{{ introduction }}</p>
    </div>
</div>
...
<div class="container center-child hug-top hug-bottom">
    <ul class="social">
        <li><a href="{{ twitter_url }}" class="social-icon"> <i class="fa fa-twitter"></i></a></li>
        <li><a href="{{ github_url }}" class="social-icon"> <i class="fa fa-github"></i></a></li>
        <li><a href="{{ linkedin_url }}" class="social-icon"> <i class="fa fa-linkedin"></i></a></li>
    </ul>
</div>

<div class="container center-child hug-top">
    <p>Written in Bash, if you're into that sort of thing.</p>
</div>
